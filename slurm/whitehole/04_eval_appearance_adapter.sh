...
ADAPTER_CHECKPOINT="${ADAPTER_CHECKPOINT:-outputs/adaptation/two_rooms_medium/adapter_latest.ckpt}"
DATA_PATH="${DATA_PATH:-outputs/data/two_rooms_len17_3m.npz}"
APPEARANCE_SHIFT="${APPEARANCE_SHIFT:-medium}"
OUTPUT_JSON="${OUTPUT_JSON:-outputs/eval/two_rooms_medium_adapter_eval.json}"
