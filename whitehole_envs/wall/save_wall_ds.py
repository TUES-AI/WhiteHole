...
def main():
    # yaml file for WhiteHole experiment using random exploratory dataset
    args = parse_args()
    ...
    # output_path = f'/whitehole_envs/wall/presaved_datasets/wall-visual-{config_name}_{ds_name_suffix}-v0.npz'
