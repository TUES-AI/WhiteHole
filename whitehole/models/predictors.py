...
from whitehole.models.misc import build_mlp
from whitehole import models
from .utils import *
from whitehole.models.enums import PredictorConfig, PredictorOutput
...
def build_predictor(
    ...
    if arch == "mlp":
        raise NotImplementedError("MLP action-conditioned predictors are not supported")
    if arch == "conv":
