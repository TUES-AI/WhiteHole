...
from whitehole.probing.evaluator import ProbingConfig, ProbingEvaluator
from whitehole.planning.wall.enums import WallMPCConfig
from whitehole.data.enums import ProbingDatasets, DatasetType
from whitehole.planning.enums import LevelConfig
from whitehole.planning.wall.mpc import WallMPCEvaluator
...
class Evaluator:
    ...
    def _get_planning_config(self):
        if self.config.env_name != "wall":
            raise NotImplementedError
        return self.config.wall_planning
